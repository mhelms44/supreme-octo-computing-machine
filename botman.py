...
class Music:
    ...
    async def omg(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('omg.mp3')
            player.start()
    ...
    async def wtf(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('wtf.mp3')
            player.start()
        except Exception as e:
            fmt = 'Yo you suck tho haha!: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def myself(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('myself.mp3')
            player.start()
        except Exception as e:
            fmt = 'Yo you suck tho haha!: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def friends(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('friends.mp3')
            player.start()
        except Exception as e:
            fmt = 'Yo you suck tho haha!: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def selfish(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('selfish.mp3')
            player.start()
        except Exception as e:
            fmt = 'Yo you suck tho haha!: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def beh(self, ctx):
        ...
        try:
            player = state.voice.create_ffmpeg_player('beh.mp3')
            player.start()
        except Exception as e:
            fmt = 'Yo you suck tho haha!: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
...
mytoken = open("tokenfile","r").readline()
bot.run(mytoken)